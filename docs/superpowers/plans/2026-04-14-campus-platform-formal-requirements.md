...
> **Placeholder note:** Any literal `TODO-*` markers shown below are preserved as historical example content inside this superseded workflow plan. They are not open repository tasks and should not be treated as current follow-up work.
